        ...
        pub mod component {
            ...
            pub mod processing_node {
                ...
                pub trait Guest {
                    ...
                    ///     let output = input; // Example: echo input
                    ///     Ok(output)
                    /// }
                    /// ```
                    ///
...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_rle_component_impl {
    ($ty:ident) => {
...
#[doc(inline)]
pub(crate) use __export_rle_component_impl as export;
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:dagwood:rle-component@1.0.0:rle-component:encoded world"
)]
#[doc(hidden)]
...
ocessing-node@1.0.0\x05\0\x04\0)dagwood:rle-component/rle-component@1.0.0\x04\0\x0b\
\x13\x01\0\x0drle-component\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dw\
